...
export const preferredPartnerOptions = [
  { value: "", label: "Select Preferrecd Partner" },
  { value: "Male", label: "Male" },
  { value: "Female", label: "Female" },
  { value: "Non-binary", label: "Non-binary" },
...
export const complexionOptions = [
  ...
  { value: "Blotchy", label: "Blotchy" },
];

export const physicalDisabilityOptions = [
...
export const astrologicalSignOptions = [
